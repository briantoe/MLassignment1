...
Original file is located at
    https://colab.research.google.com/drive/1MHVAuPJ8k6gZsCJXnIyQ18D6WJzc8rTN
...
url = 'https://gist.githubusercontent.com/briantoe/a9d7e3a6f5b2a3b842247364538bf7c7/raw/525a3b2551909f7a50783ceaa77e49d7dc8417f0/mush_train.data'
training_data = pd.read_csv(url, header=None)
...
class Question:
    ...
    def __repr__(self):
        ...
        if is_numeric(self.value):
            condition = ">="
        return "Is %s %s %s?" % (
            attribute_types[self.column], condition, str(self.value))
...
url = 'https://gist.githubusercontent.com/briantoe/b0fefddfb869bf6d8529598f784efb74/raw/707f0c300f00eb5bdfbd1f6a1be4659ca3005339/mush_test.data'
testing_data = pd.read_csv(url, header=None)
